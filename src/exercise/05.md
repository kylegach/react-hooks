...
- Refs. How to define one, and when it is available to use
- Why refs are useful
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Hooks%20%F0%9F%8E%A3&e=05%3A%20useRef%20and%20useEffect%3A%20DOM%20interaction&em=kyle.gach%40gmail.com).
